...
const EarnWithFwenBot = () => {
    return (
        <section className="container my-20 flex h-fit flex-col-reverse justify-around gap-8 overflow-hidden rounded-[40px] border-2 border-cyan-200 bg-cyan-200/20 p-10 md:flex-row">
            <div className="">
