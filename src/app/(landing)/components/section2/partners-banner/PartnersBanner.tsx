...
const PartnersBanner: React.FC<PartnersBannerProps> = ({ scrollYProgress }) => {
    ...
    return (
        <div className="container relative mt-3.5 flex w-full justify-around overflow-hidden bg-yellow-200 py-10">
            {images.map((image, index) => (
                <div
                    key={index}
                    className="aspect-[3.69] w-[255px] max-w-[240px] object-contain relative"
                >
                    <Image
                        loading="lazy"
                        src={image.src}
